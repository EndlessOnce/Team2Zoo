  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
         <li><a href="~/View/Animal/AddAnimal.aspx">Animal</a></li>
         <li><a href="~/View/Employee/AddEmployee.aspx">Employee</a></li>
        <li class="active"><a href="#">User</a></li>
        <li><a href="Member/AddMember.aspx">Member</a></li>
        <li><a href="~/View/Shop/AddShop.aspx">Shop</a></li>
        <li><a href="~/View/Show/AddShow.aspx">Show</a></li>
        <li><a href="~/View/Transaction/AddTransaction.aspx">Transaction</a></li>
        <li><a href="~/View/Visitor/AddVisitor.aspx">Visitor</a></li>
      </ul>
