...
<head runat="server">
  ...
  <title>Delete Show</title>  <!--edit here-->
  <meta charset="utf-8">
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      <h1>Delete Show Information</h1>    <!--edit here also below this-->
      ...
      <hr>
       ...
       <p class="text-right">
        ...
        <h3 style="text-align:center"><strong><u>Show Information</u></strong></h3> <!--edit here also below this-->
    ...
    <p>
      ...
      <button type="submit" runat="server" id="show_del">Delete</button>   <!--edit here also below this-->
            </span>
        </p>
