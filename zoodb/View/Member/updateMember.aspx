<%@ Page Language="C#" AutoEventWireup="true" CodeFile="updateMember.aspx.cs" Inherits="zoodb.updateMember" %>
...
<head runat="server">
  ...
  <title>Update Member</title>   <!-- edit this -->
  <meta charset="utf-8">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
          <li class ="active"><a href ="updateMember.aspx">Update Member</a></li>
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      <h1>Update Member Information</h1>              <!-- edit this -->
